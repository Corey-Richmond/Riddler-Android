...
public class GetNameInBackground extends AbstractGetNameTask {
  ...
  public GetNameInBackground(LogonActivity activity, String email, String scope, int requestCode) {
  ...
  private Intent makeCallback(String accountName) {
      ...
      intent.putExtra(LogonActivity.EXTRA_ACCOUNTNAME, accountName);
      return intent;
  }
