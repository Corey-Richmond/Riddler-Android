...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void>{
    ...
    public static void setmEmailAddress(String mEmailAddress) {
		AbstractGetNameTask.mEmailAddress = mEmailAddress;
	}


	public static String getmEmailAddress() {
    ...
    AbstractGetNameTask(LogonActivity activity, String email, String scope, int requestCode) {
        this.mActivity = activity;
        this.mScope = scope;
        this.mEmail = email;
        this.mRequestCode = requestCode;
        setmEmailAddress(mEmail);
    }
